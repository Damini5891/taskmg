...
<head>
  ...
  ?>   
    ...
    <div class="header-left">
        <!-- Search by Task Status Dropdown -->
        <label for="sel">Search By Task Status:</label>
        <select id="sel" name="sel" onchange="searchByStatus()">
            <option value="pending">Pending</option>
            <option value="working">Working</option>
            <option value="completed">Completed</option>
        </select>

        <!-- Search by Projects Dropdown -->
        <label for="projects">Search By Projects:</label>
        <select id="projects" name="projects" onchange="searchByProject()">
            <?php
